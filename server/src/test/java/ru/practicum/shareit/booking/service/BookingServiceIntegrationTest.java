...
class BookingServiceIntegrationTest {
    ...
    private BookingCreationDto bookingCreationDto2;
    ...
    void setUp() {
        ...
        booking2 = Booking.builder()
                ...
                .status(BookingStatus.APPROVED)
                .build();
        bookingCreationDto2 = BookingCreationDto.builder()
                .id(5L)
                .start(now.minusDays(3))
                .end(now.minusDays(5))
                .itemId(savedItem.getId())
    ...
    public void getOwnerAllItemBookings() {
        ...
        int from = 0;
        int size = 10;
        List<BookingDto> bookingDtoList = bookingService.getOwnerAllItemBookings(userId, BookingState.ALL, from, size);
