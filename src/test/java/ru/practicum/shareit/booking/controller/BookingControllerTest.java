...
class BookingControllerTest {
    ...
    @Test
    public void shouldRenewalBooking() throws Exception {
        bookingCreationDto.setStatus(BookingStatus.APPROVED);
        when(bookingService.renewalBooking(anyLong(), anyLong(), anyBoolean())).thenReturn(bookingDto);
    ...
    public void shouldNotRenewalBookingByNotOwner() throws Exception {
        bookingCreationDto.setStatus(BookingStatus.APPROVED);
        when(bookingService.renewalBooking(anyLong(), anyLong(), anyBoolean()))
